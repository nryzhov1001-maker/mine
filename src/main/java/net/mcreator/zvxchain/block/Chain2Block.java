...
public class Chain2Block {
    ...
    public static class CustomBlock extends Block {
        private static final AxisAlignedBB AABB_VERTICAL = new AxisAlignedBB(0.2, 0.0, 0.2, 0.8, 1.0, 0.8);
        private static final AxisAlignedBB AABB_HORIZONTAL_NS = new AxisAlignedBB(0.2, 0.2, 0.0, 0.8, 0.8, 1.0);
        private static final AxisAlignedBB AABB_HORIZONTAL_EW = new AxisAlignedBB(0.0, 0.2, 0.2, 1.0, 0.8, 0.8);

        public CustomBlock() {
            super(Material.IRON);
            setUnlocalizedName("chain_2");
            setRegistryName("chain_2");
    ...
    public static void registerModel() {
        ModelLoader.setCustomModelResourceLocation(itemBlock, 0, new ModelResourceLocation(ZvxchainMod.MODID + ":chain_2", "inventory"));
    }
}
